...
public class Robot_ERROR_CODE_ESTest_scaffolding {
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(Robot_ERROR_CODE_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "net.virtualinfinity.atrobots.measures.AbsoluteAngle$1",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(Robot_ERROR_CODE_ESTest_scaffolding.class.getClassLoader()); 
